...
<head>
    ...
    <title>Mobil 1&trade; 0W-40 | Car Engine Oils &amp; Products | Mobil&trade; Canada</title>
    <meta name="keywords" content="Car Engine Oils, Mobil 1 0W-40, engine oil, motor oil, lubricant" />
    <meta name="description"
        content="Mobil 1&trade; 0W-40 is an advanced performance synthetic engine oil designed to help provide exceptional cleaning power, wear protection and overall performance." />
    <meta name="date" content="2010-07-01" />
    <meta name="language" content="en" />
    <meta http-equiv="Content-Language" content="en" />
    <meta name="WT.ti" content="Mobil 1&trade; 0W-40 | Car Engine Oils &amp; Products | Mobil&trade; Canada" />
...
<body class="article">
    <div style="text-align:left">
        <script type="text/javascript">displaySuperPencil("0915881d81d397e8");</script>
    </div>
    ...
    <div id="mainPanel" class="clrfix">
        <!-- googleoff: all -->
        <script
            type="text/javascript">quickEditForm('0915881d81d397e8', '/Content', false, '../forms/LCWLeftNav', '', '500px', '300px', 'Display/Hide Left Navigation', '', 'pencil.gif', '10px');</script>
        <!-- googleon: all -->
        ...
        <div id="toolbar_wide">
            ...
            <div style="float:left">
                <script
                    type="text/javascript">quickEditForm('0915881d81d397e8', '/Content/Related_Links', true, '../forms/LCWRelatedLinks', '', '820px', '640px', 'Related Links', '', 'pencil.gif', '');</script>
            </div><!-- googleon: all -->
            ...
            <div class="related">
                <div style="float:left">
                    <a xmlns="" target="_self" onclick="trackClick(this);"
                        href="../Canada-English-LCW/carengineoils_products_mobil-1_10w30.aspx"><img width="60"
                            title="Mobil 1 10W-30" src="../Canada-English-LCW/Images/teaser_60x60_mobil-1-10w30.jpg"
                            longdesc="" height="60" border="0" alt="Mobil 1 10W-30"></a> </div>
                <h2>
                    <a title="" target="_self"
                        href="/Canada-English-LCW/carengineoils_products_mobil-1_10w30.aspx">Mobil 1&trade; 10W-30</a>
                </h2>
                <div class="relatedContent">
                    <p xmlns="">&nbsp;&nbsp;</p>&#160;
                </div>
            ...
            <div class="related">
                ...
                <h2>
                    <a title="" target="_self"
                        href="/Canada-English-LCW/carengineoils_products_mobil-1_ep-5w30.aspx">Mobil&trade; EP 5W-30</a>
                </h2>
                <div class="relatedContent">
                    <p xmlns="">&nbsp;&nbsp;</p>&#160;
                </div>
        ...
        <div id="mainContent_thin">
            <!-- googleoff: all -->
            <script
                type="text/javascript">quickEditForm('0915881d81d397e8', '/Content', false, '../forms/LCWProductDetails', '', '825px', '750px', 'Product Detail Overview', '', 'pencil.gif', '200px');</script>
            <!-- googleon: all -->
            <div id="topSec">
                ...
                <p xmlns="" align="left">
                    <a title="" target="" onclick="trackClick(this);"
                        href="/Canada-English-LCW/Images/product_640x800_mobil-1-0w-40.jpg" class="lightview"><img
                            src="../Canada-English-LCW/Images/product_120x150_mobil-1-0w40.jpg" height="150" width="120"
                            alt="Mobil 1 0W-40" title="Mobil 1 0W-40" align="left" border="15" hspace="5"></a>
                </p>

                <p xmlns="">
                    <strong>Advanced Synthetic Engine Oil<br>

                    </strong>
                    Mobil 1 FS 0W-40 Advanced Synthetic Motor Oil is engineered for the latest gasoline and diesel
                    (without Diesel Particulate Filters or DPFs) engine technology delivering excellent all-round
                    performance. It provides exceptional cleaning power, wear protection and overall performance. Mobil
                    1 FS 0W-40 keeps your engine running like new.</p>
            </div>
            <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                <tr id="tabNav">
                    <td style="height:1px; padding-bottom:-10px; " colspan="5">
                        <!-- googleoff: all -->
                        <script
                            type="text/javascript">quickEditForm('0915881d81d397e8', '/Content/Tabs', true, '../forms/LCWProductDetailsTabs', '', '790px', '775px', 'Product Detail Tabs', '', 'pencil.gif', '220px');</script>
                        <!-- googleon: all -->
                ...
                <tr id="trTabContent">
                    ...
                    <td valign="top"
                        ...
                        <div style="width:434px; white-space:normal; padding-top:10px;display:block "
                            ...
                            <p xmlns="">Mobil 1 FS 0W-40 is made with a proprietary blend of ultra high performance
                                synthetic basestocks fortified with a precisely balanced component system.</p>

                            <ul xmlns="">

                                <li>Meets most OEM and Industry approvals</li>

                                <li>Provides excellent overall performance</li>

                                <li>Has excellent low temperature capabilities for rapid engine protection at start-up
                                </li>

                                <li>Offers unsurpassed protection for reduced engine wear and deposits even in the most
                                    extreme driving conditions</li>
                        ...
                        <div style="width:415px; white-space:normal; padding-top:10px;display:none "
                            ...
                            <p xmlns="">Thanks to extensive cooperative development work with major manufacturers and
                                the application of the latest lubrication technology, Mobil 1 FS 0W-40 is recommended
                                for many types of modern vehicles where it will help provide unsurpassed performance
                                even under very demanding driving conditions.</p>

                            <ul xmlns="">

                                <li>Latest engine technologies including Turbo-chargers, Direct Injection, Diesels
                                    (without DPF) and Hybrids</li>
                            ...
                            <p xmlns="">Always consult your owner&rsquo;s manual to check recommended viscosity grade
                                and specifications for your particular vehicle.</p>
                        </div>
                        <div style="width:415px; white-space:normal; padding-top:10px;display:none "
                        ...
                        <div style="width:415px; white-space:normal; padding-top:10px;display:none "
                            ...
                            <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                                <thead>
                                    <tr>
                                        <th width="" scope="col" height="" class="standard"><strong>Mobil 1
                                                0W-40</strong></th>
                                        <th width="" scope="col" height="" class="standard"><strong>Value</strong></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td width="" height="" class="standard">Viscosity, cSt (ASTM D445)</td>
                                        <td width="" height="" class="standard">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td width="" height="" class="standard">@ 40º C</td>
                                        <td width="" height="" class="standard">70.8</td>
                                    </tr>
                                    <tr>
                                        <td width="" height="" class="standard">@ 100º C</td>
                                        <td width="" height="" class="standard">12.9</td>
                                    </tr>
                                    <tr>
                                        <td width="" height="" class="standard">Viscosity Index</td>
                                        <td width="" height="" class="standard">186</td>
                                    </tr>
                                    <tr>
                                        <td width="" height="" class="standard">MRV at -40ºC, cP (ASTM D4684 apparent
                                            viscosity)</td>
                                        <td width="" height="" class="standard">21600</td>
                                    </tr>
                                    <tr>
                                        <td width="" height="" class="standard">HTHS Viscosity, mPa&bull;s @ 150ºC,
                                            (ASTM D4683)</td>
                                        <td width="" height="" class="standard">3.6</td>
                                    </tr>
                                    <tr>
                                        <td width="" height="" class="standard">Total Base Number (ASTM D2896)</td>
                                        <td width="" height="" class="standard">12.6</td>
                                    </tr>
                                    <tr>
                                        <td width="" height="" class="standard">Sulfated Ash, wt% (ASTM D874)</td>
                                        <td width="" height="" class="standard">1.34</td>
                                    </tr>
                                    <tr>
                                        <td width="" height="" class="standard">Phosphorous, wt% (ASTM D4981)</td>
                                        <td width="" height="" class="standard">0.1</td>
                                    </tr>
                                    <tr>
                                        <td width="" height="" class="standard">Flash Point, ºC (ASTM D92)</td>
                                        <td width="" height="" class="standard">226</td>
                                    </tr>
                                    <tr>
                                        <td width="" height="" class="standard">Density @15.6 ºC, g/ml&nbsp; (ASTM
                                            D4052)</td>
