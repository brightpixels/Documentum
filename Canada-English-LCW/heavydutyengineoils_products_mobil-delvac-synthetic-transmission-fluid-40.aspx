...
<%@ Register Src="Navigation/heavydutyoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil Delvac&trade; Synthetic Transmission Fluid 40 | Heavy Duty Engine Oils</title>
        <meta name="keywords" content="Mobil Delvac Synthetic Transmission Fluid 40"/>
        <meta name="description" content="Mobil Delvac&trade; Synthetic Transmission Fluid 40 is a synthetic, manual transmission lubricant engineered to meet the most demanding extended drain."/>
        <meta name="date" content="2017-09-01"/>
        <meta name="language" content="en"/>
        <meta http-equiv="Content-Language" content="en"/>
        <meta name="WT.ti" content="Mobil Delvac&trade; Synthetic Transmission Fluid 40 | Heavy Duty Engine Oils"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d81f0fa6f");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d81f0fa6f','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d81f0fa6f', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    ...
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d81f0fa6f', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Features &amp; Benefits Content">
                                    <ul xmlns="">
                                        <li>Excellent load carrying and anti-wear performance</li>
                                        <li>Outstanding protection against deposit formation</li>
                                        <li>Maximum protection from corrosion of copper and its alloys</li>
                                        <li>Optimized thermal and oxidation protection</li>
                                        <li>Exceptional shear stability</li>
                                        <li>Outstanding low-temperature fluidity</li>
                                        <li>Extended drain and service interval capability</li>
                                        <li>Improved friction reduction properties</li>
                                    </ul>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Specs Content">
                                    <p xmlns="">
                                        <strong>Mobil Delvac 1 Transmission Fluid 40 meets or exceeds the requirements of the following industry and builder specifications: </strong>
                                        <br>
API MT-1</p>
                                    <p xmlns="">
                                        <strong>Mobil Delvac 1 Transmission Fluid 40 has the following builder approvals: </strong>
                                        <br>
Eaton PS-386<br>
Mack TO-A PLUS<br>
Navistar MPAPS B-6816 Type 2<br>
&nbsp;</p>
                                </div>
                                    ...
                                    <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                                        <thead>
                                            <tr>
                                                <th width="" scope="col" height="" class="standard">
                                                    ...
                                                    <p>Mobil Delvac Synthetic Transmission Fluid 40</p>
                                        ...
                                        <tr>
                                            <td width="" height="" class="standard">
                                                ...
                                                <p>Density @ 15.6ºC g/ml, ASTM D 1298</p>
