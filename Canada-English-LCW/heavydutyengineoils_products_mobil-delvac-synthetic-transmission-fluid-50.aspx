...
<%@ Register Src="Navigation/heavydutyoils.ascx" TagName="Navigation" TagPrefix="xom" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head><meta http-equiv="X-UA-Compatible" content="IE=8">
        <title>Mobil Delvac&trade; Synthetic Transmission Fluid 50| Heavy Duty Engine Oils</title>
        <meta name="keywords" content="Mobil Delvac Synthetic Transmission Fluid 50"/>
        <meta name="description" content="Mobil Delvac&trade; Synthetic Transmission Fluid 50 is a synthetic, manual transmission lubricant engineered to meet the most demanding extended drain."/>
        <meta name="date" content="2010-01-01"/>
        <meta name="language" content="en"/>
        <meta http-equiv="Content-Language" content="en"/>
        <meta name="WT.ti" content="Mobil Delvac&trade; Synthetic Transmission Fluid 50| Heavy Duty Engine Oils"/>
    ...
    <body class="article">
        <div style="text-align:left">
            <script type="text/javascript">displaySuperPencil("0915881d82055a27");</script>
        </div>
        ...
        <div id="container"><!--#include file="Navigation/Header.aspx" -->
            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                <script type="text/javascript">quickEditForm('0915881d82055a27','/Content',false,'../forms/LCWLeftNav','','500px','300px','Display/Hide Left Navigation','','pencil.gif','10px');</script><!-- googleon: all -->
                ...
                <div id="toolbar_wide"><!--#include file="Services/Toolbox.aspx" --><!-- googleoff: all -->
                    <div style="float:left">
                        <script type="text/javascript">quickEditForm('0915881d82055a27', '/Content/Related_Links',true,'../forms/LCWRelatedLinks','','820px','640px','Related Links','','pencil.gif','');</script>
                    </div><!-- googleon: all -->
                    ...
                    <div class="related">
                        <div style="float:left">
                            <a xmlns="" target="_self" onclick="trackClick(this);" href="../Canada-English-LCW/heavydutyengineoils_products_mobiltrans-hd-30.aspx"><img width="60" title="Mobiltrans AST 30" src="../Canada-English-LCW/Images/teaser_60x60_mobiltrans-ast-30.jpg" longdesc="" height="60" border="0" alt="Mobiltrans AST 30"></a> </div>
                        <h2>
                            <a title="" target="_self" href="/Canada-English-LCW/heavydutyengineoils_products_mobiltrans-hd-30.aspx">Mobiltrans&trade; AST 30</a>
                        </h2>
                        <div class="relatedContent">
                            <p xmlns="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>&#160;</div>
                    </div>
                    ...
                    <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
                        <tr id="tabNav">
                            <td style="height:1px; padding-bottom:-10px; " colspan="5"><!-- googleoff: all -->
                                <script type="text/javascript">quickEditForm('0915881d82055a27', '/Content/Tabs',true,'../forms/LCWProductDetailsTabs','','790px','775px','Product Detail Tabs','','pencil.gif','220px');</script><!-- googleon: all -->
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Features &amp; Benefits Content">
                                    <ul xmlns="">
                                        <li>Excellent load carrying, anti-wear, and EP performance - Extends transmission life and reduces cost of operation</li>
                                        <li>Outstanding protection against deposit formation - Longer seal life, extended drain, and service intervals</li>
                                        <li>Maximum protection from corrosion of copper and its alloys - Protects and extends the life of synchronisers</li>
                                        <li>Optimized thermal and oxidation protection - Extends component life and improves efficiency</li>
                                        <li>Exceptional shear stability - Excellent wear during severe operation</li>
                                        <li>Outstanding low-temperature fluidity - Reduces wear during cold temperatures and improves shifting with quicker starts</li>
                                        <li>Extended drain and service interval capability - Provides lower operating costs and higher productivity</li>
                                    </ul>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Specs Content">
                                    <p xmlns="">
                                        <strong>Mobil Delvac Synthetic Transmission Fluid 50 meets the following industry and builder specifications:<br>

                                        </strong>API MT-1</p>

                                    <p xmlns="">
                                        <strong>Mobil Delvac Synthetic Transmission Fluid 50 has the following builder approvals:<br>

                                        </strong>Eaton Roadranger E500 (TM) PS-164 Rev 7 <br>
Mack TO-A Plus <br>
International TMS-6816</p>
                                </div>
                                        ...
                                        <thead>
                                            <tr>
                                                <th width="" scope="col" height="" class="standard">
                                                    <p>Mobil Delvac Synthetic Transmission Fluid 50</p>
