            ...
            <div id="mainPanel" class="clrfix"><!-- googleoff: all -->
                ...
                <div id="mainContent_thin"><!-- googleoff: all -->
                    ...
                    <div id="topSec">
                        ...
                        <p xmlns="">Mobil 1&trade; FS 0W-40 European Car Formula (Nord-Amerika) eller Protection Formula (i resten av verden) er en avansert, helsyntetisk motorolje som er utviklet for den nyeste bensin- og dieselmotorteknologien (uten dieselpartikkelfilter eller DPF-er) og leverer utmerket allsidig ytelse. Oljen gir eksepsjonell rengj�ringsevne, slitasjebeskyttelse og totalytelse. Mobil 1 FS 0W-40 gj�r at motoren fungerer som ny under alle kj�reforhold.<br>
&nbsp;</p>
                    </div>
                        ...
                        <tr id="trTabContent">
                            ...
                            <td valign="top" style="width: 435px; background-image:url('/Images/Tabs/boxNoFade_Upper.png'); background-repeat: repeat-x; background-color: #ffffff;" class="midBorder">
                                <div style="width:434px; white-space:normal; padding-top:10px;display:block " class="divTabContent" id="Fordeler Content">
                                    <p xmlns="">Mobil 1 FS 0W-40 er fremstilt med en patentert blanding av h�ytytende syntetiske baseoljer som er forsterket med et n�ye balansert tilsetningssystem.&nbsp;</p>
                                    <p xmlns="">&nbsp;</p>
                                    <ul xmlns="">
                                        <li>M�ter eller overg�r de nyeste OEM- og bransjegodkjenninger</li>
                                        <li>Gir utmerket totalytelse</li>
                                        <li>Har utmerkede egenskaper for hurtig oppstart ved lave temperaturer</li>
                                        <li>Har forbedrede friksjonsegenskaper som gir god drivstoff�konomi</li>
                                        <li>Gir rask beskyttelse for redusert motorslitasje og avleiringer, selv under de mest ekstreme kj�reforhold</li>
                                        <li>S�rger for eksepsjonell rengj�ring av skitne motorer.&nbsp;</li>
                                    </ul>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Bruksomr�der Content">
                                    <p xmlns="">Takket v�re utstrakt samarbeid med st�rre produsenter og bruk av den nyeste sm�reteknologien, kan Mobil 1 FS 0W-40 anbefales til praktisk talt alle typer moderne kj�ret�y, hvor den gir optimal ytelse selv under sv�rt krevende kj�reforhold.</p>
                                    <p xmlns="">&nbsp;</p>
                                    <ul xmlns="">
                                        <li>Den nyeste motorteknologien, inkludert turbo-, direkte innspr�ytnings-, diesel- (uten dieselpartikkelfilter) og hybridmotorer</li>
                                        <li>H�ytytende motorer</li>
                                        <li>De fleste driftsforhold, fra milde til ekstreme</li>
                                    </ul>
                                    <p xmlns="">Les alltid brukerh�ndboken for � sjekke anbefalt viskositetsgrad og spesifikasjoner for det aktuelle kj�ret�yet.</p>
                                </div>
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Spesifikasjoner Content">
                                    <p xmlns="">
                                        <strong>Mobil 1 FS 0W-40 tilfredsstiller eller overg�r kravene til:</strong>
                                        <br>
API, SN, SM, SL, SL<br>
ACEA A3/B3, A3/B4</p>

                                    <p xmlns="">
                                        <strong>Mobil 1 FS 0W-40 har f�lgende utstyrsprodusentgodkjennelser:</strong>
                                        <br>
...
Nissan Genuine Performances</p>
                                    ...
                                    <p xmlns="">
                                        <strong>I henhold til ExxonMobil har Mobil 1 FS 0W-40 en av f�lgende kvaliteter:</strong>
                                        <br>
API CF<br>
VW 503 01<br>
FIAT 9.55535-M2</p>
                                ...
                                <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Egenskaper Content">
                                    <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                                        ...
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;ved 40 �C</td><td width="" height="" class="standard">&nbsp;70.8</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;ved 100 �C</td><td width="" height="" class="standard">&nbsp;12.9</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;Viskositetsindeks</td><td width="" height="" class="standard">&nbsp;186</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;MRV ved -40 �C, cP (ASTM D4684)</td><td width="" height="" class="standard">&nbsp;21600</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;HTHS-viskositet, mPa&bull;s ved 150 �C (ASTM D4683)</td><td width="" height="" class="standard">&nbsp;3.6</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;Flammepunkt, �C (ASTM D 92)</td><td width="" height="" class="standard">&nbsp;226</td>
                                        </tr>
                                        <tr>
                                            <td width="" height="" class="standard">&nbsp;Densitet ved 15 �C g/ml (ASTM D4052)</td><td width="" height="" class="standard">&nbsp;0.8456</td>
                                        </tr></tbody></table>
                                </div>
                            </td>
