<%@ Page Language="C#" AutoEventWireup="false" Inherits="XOM.Common.Web.XOMPage" %> <%@ Register TagPrefix="XOM" Namespace="XOM.Common.Web"
Assembly="XOMCommon" %> <%@ Register Src="Navigation/carengineoils.ascx" TagName="Navigation" TagPrefix="xom" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Mobil 1&trade; is the world&rsquo;s leading synthetic motor oil brand delivering our ultimate performance and protection."
    />
    ...
    <link rel="canonical" href="<%="http://www.mobil.co.uk"+Request.ServerVariables.Get("URL")%>" />
  ...
  <body class="article">
    <div style="text-align:left">
      <script type="text/javascript">
        displaySuperPencil('0915881d8207d863');
      </script>
    </div>
    ...
    <div id="container">
      ...
      <div id="navPanelBottomBg" class="clrfix"><div id="navPanelBottom"></div></div>
    </div>
    <div id="mainPanel" class="clrfix">
      ...
      <div id="sideBar" class="clrfix">
        ...
        <!--#include file="Navigation/QuickLinks_carengineoils.aspx"-->
      </div>
      <div id="toolbar_wide">
      ...
      <div id="mainContent_thin">
        ...
        <div id="topSec">
          <div style="float:left" id="flash">
            <img
              xmlns=""
              src="../Shared-Images-LCW/120x150_mobil-1_fs_0w40.jpg"
              height="150"
              width="120"
              alt="Mobil 1 FS 0W-40"
              title="Mobil 1 FS 0W-40"
              border="0"
              hspace="0"
            />
          </div>
          <h1><strong xmlns="">Mobil 1 FS 0W-40</strong></h1>
          Mobil 1&trade; is the world&rsquo;s leading synthetic motor oil brand delivering our ultimate performance and protection.
          <p xmlns="" style="text-align: justify; margin: 0in 0in 10pt">
            Mobil 1&trade; FS 0W-40 European Car Formula (North America) or Protection Formula (rest of the World) Advanced Full Synthetic Motor Oil
            is engineered for the latest gasoline and diesel (without Diesel Particulate Filters or DPFs) engine technology delivering excellent
            all-round performance. It provides exceptional cleaning power, wear protection and overall performance. Mobil 1 FS 0W-40 keeps your engine
        ...
        <table style="width: 454px   " id="tblTabs" cellspacing="0px" cellpadding="0" border="0">
          ...
          <tr id="trTabContent">
            ...
            >
              ...
              >
                Mobil 1 FS 0W-40 is made with a proprietary blend of ultra high performance synthetic basestocks fortified with a precisely balanced
                component system.
                <ul xmlns="">
              ...
              <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Applications Content">
                Thanks to extensive cooperative development work with major manufacturers and the application of the latest lubrication technology,
                Mobil 1 FS 0W-40 is recommended for many types of modern vehicles where it will help provide unsurpassed performance even under very
                ...
                <p xmlns="" style="margin: 0in 0in 10pt">
                  Always consult your owner&rsquo;s manual to check recommended viscosity grade and specifications for your particular vehicle.
                </p>
              </div>
              ...
              <div style="width:415px; white-space:normal; padding-top:10px;display:none " class="divTabContent" id="Tech. Details Content">
                <table xmlns="" width="100%" summary="" class="standard" cellspacing="0" border="0">
                  <thead>
                    <tr>
                      <th width="" scope="col" height="" class="standard"><strong>Mobil 1 FS 0W-40</strong></th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td width="" height="" class="standard">&nbsp;MRV at -40ºC, cP (ASTM D4684)</td>
                      <td width="" height="" class="standard">&nbsp;21600</td>
                    </tr>
                    <tr>
                      <td width="" height="" class="standard">&nbsp;HTHS Viscosity, mPa&bull;s @ 150ºC, (ASTM D4683)</td>
                    ...
                    <tr>
                      <td width="" height="" class="standard">&nbsp;Density @15ºC, g/ml&nbsp; (ASTM D4052)</td>
